...
function refreshImg() {
  ...
  var verImg = $('.verImg')
  if (verImg.length) {
    verImg.attr('src', `img/verification/${imgs[index]}.jpg`)
  } else {
    imgBox.prepend(`<img class='verImg' src="img/verification/${imgs[index]}.jpg" />`)
  }
  verify.css('background-image', `url('img/verification/${imgs[index]}.jpg')`)
}
